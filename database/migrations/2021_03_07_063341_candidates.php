...
class Candidates extends Migration
{
    ...
    public function up()
    {
        ...
        $table->tinyInteger('gender',4)->unsigned()->nullabe()->default(NULL);
        ...
        $table->integer('created_by',11)->unsigned()->nullabe()->default(NULL);
        $table->integer('modified_by',11)->unsigned()->nullabe()->default(NULL);
